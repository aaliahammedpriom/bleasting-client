    ...
    return (
        <div className='  bg-cover bg-center bg-no-repeat '
            ...
            <div className='h-full w-full bg-white/80'>
                <RandomWave curves={100} width={1440} height={30} fill="#000000" />
                ...
                <div className='md:w-[70vw] max-sm:px-5  m-auto flex flex-col  gap-10  py-10'>
                    ...
                    <h1 className='md:text-xl font-bold text-[#000000] text-center ' >Our Bleasting body transformation experts are here to help, contact us today with any queries you may have. Alternatively send us a message on Whatsapp +66629327367. </h1>
                    <div className='md:w-1/2 m-auto'>
                        <ContactFormGrid></ContactFormGrid>
                    </div>
                </div>
                <RandomWave curves={100} width={1440} rotation={true} height={30} fill="#000000" />
